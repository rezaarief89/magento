...
namespace Fef\CustomShipping\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const XML_SANDBOX_CAL_URL_CONFIG = 'carriers/custom/sandbox_order_cal_url';
    ...
    const XML_PROD_URL_CAL_CONFIG = 'carriers/custom/production_order_cal_url';
    ...
    public function setCurl($url, $method, $param = null, $useToken = 0)
    {
        ...
        // $logger->info("================ setCurl Function ================");
        // $logger->info("URL : $url");
        // $logger->info("params : ".json_encode($param));
        ...
        if($this->getConfig(self::XML_SANDBOX_FLAG)==1){
            switch ($type) {
                ...
                case 'rate':
                    ...
                    break;
                case 'cal':
                    $key = self::XML_SANDBOX_CAL_URL_CONFIG;
                    break;
                default:
                    $key = "";
                    break;
            ...
            switch ($type) {
                ...
                case 'rate':
                    ...
                    break;
                case 'cal':
                    $key = self::XML_PROD_URL_CAL_CONFIG;
                    break;
                default:
                    $key = "";
                    break;
