...
class Refund extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
		...
		$query = "SELECT 
					...
					AND DATE_ADD(o.created_at, INTERVAL 8 HOUR) >= '2024-08-01 00:00:00'
